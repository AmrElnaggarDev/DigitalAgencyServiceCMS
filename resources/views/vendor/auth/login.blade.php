...
<div class="box">
    ...
    <p style="margin-top:14px"><a href="{{ route('vendor.password.request') }}">Forgot your password?</a></p>
    <p style="margin-top:6px">No account? <a href="{{ route('vendor.register') }}">Register</a></p>
</div>
</body>
</html>
